 ...
 */
final class Version20240301083719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE meeting (id INT AUTO_INCREMENT NOT NULL, state_id INT NOT NULL, place_id INT NOT NULL, campus_id INT NOT NULL, organizer_id INT NOT NULL, name VARCHAR(255) NOT NULL, date DATETIME NOT NULL, users_max INT NOT NULL, text_note VARCHAR(255) DEFAULT NULL, duration INT NOT NULL, limit_date DATE NOT NULL, annulation_reason VARCHAR(255) DEFAULT NULL, INDEX IDX_F515E1395D83CC1 (state_id), INDEX IDX_F515E139DA6A219 (place_id), INDEX IDX_F515E139AF5D55E1 (campus_id), INDEX IDX_F515E139876C4DDA (organizer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, recipient_id INT NOT NULL, title VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_read VARCHAR(255) NOT NULL, INDEX IDX_DB021E96F624B39D (sender_id), INDEX IDX_DB021E96E92F8F78 (recipient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profile (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone VARCHAR(15) NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
